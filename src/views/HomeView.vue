...
<template>
  <main>
    ...
    <div class="dark:bg-gray-800 bg-white">
      <h1 class="dark:text-white text-black">Hello World</h1>
    </div>
  </main>
</template>
...
export default {
  ...
  data() {
    return {
      ApiKey: "c72e791979261179c0e835f9c05a1baf",
...
.WeatherApp {
  background-image: url(../../assets/Vue/Img-1.jpg);
  background-size: cover;
  background-repeat: no-repeat;
}
.warm {
  background-image: url(../../assets/Vue/Img-3.jpg);
}
main {
  min-height: 100vh;
  padding: 25px;
